...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Bamboo Company | Staff" },
      { name: "description", content: "Internal staff portal of Bamboo Company." },
      { property: "og:title", content: "Bamboo Company | Staff" },
      { property: "og:description", content: "Internal staff portal of Bamboo Company." },
